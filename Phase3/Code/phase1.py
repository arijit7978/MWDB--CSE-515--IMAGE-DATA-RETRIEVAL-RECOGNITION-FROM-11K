...
#     if (os.path.exists('hog'+folder_type+'.csv')):
#         os.remove('hog'+folder_type+'.csv')
#
...
#         with open('hog'+folder_type+'.csv', 'a',newline='') as csvFile:
...
def lbp(directory,folder_type):
    ...
    if (os.path.exists('lbp'+folder_type+'.csv')):
        os.remove('lbp'+folder_type+'.csv')
    ...
    for imagename in os.listdir(directory):
        ...
        with open('lbp'+folder_type+'.csv', 'a', newline='') as f:
